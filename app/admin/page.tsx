      ...
      <main className="container mx-auto px-3 sm:px-4 py-6 sm:py-10">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 sm:space-y-8">
          <div className="overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0 pb-2">
            ...
            <TabsTrigger value="html" className="gap-1 sm:gap-2 text-[10px] sm:text-sm px-2 sm:px-4 py-1.5 sm:py-2 data-[state=active]:bg-background data-[state=active]:shadow-sm rounded-lg transition-all">
