    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="relative py-16 sm:py-20 lg:py-24 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-b from-background via-primary/5 to-muted/40" />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_60%_at_50%_100%,rgba(120,80,200,0.10),transparent)]" />
          <div className="absolute inset-0 bg-[linear-gradient(rgba(120,80,200,0.025)_1px,transparent_1px),linear-gradient(90deg,rgba(120,80,200,0.025)_1px,transparent_1px)] bg-[size:64px_64px]" />
          <div className="container mx-auto px-4 relative">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <h3 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-foreground mb-4 tracking-tight text-balance">
                Ready to Start <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Learning?</span>
              </h3>
              <p className="text-muted-foreground text-sm sm:text-base mb-8 max-w-lg mx-auto leading-relaxed">
                Join 10,000+ students who trust TechVyro for quality study materials. Everything you need, completely free.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <a
                  href="#content"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-primary to-accent text-white text-sm font-semibold hover:opacity-90 transition-all shadow-2xl shadow-primary/30 hover:-translate-y-0.5 hover:shadow-primary/40"
                >
                  Browse All PDFs
                </a>
                <a
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border border-border/60 bg-card/60 backdrop-blur-sm text-foreground text-sm font-semibold hover:border-[#25D366]/60 hover:bg-[#25D366]/5 transition-all"
                >
