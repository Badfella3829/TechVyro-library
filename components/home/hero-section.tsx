    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-16 sm:py-24 lg:py-32 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Description */}
          <p className="text-sm sm:text-base lg:text-lg text-muted-foreground max-w-2xl mx-auto mb-6 sm:mb-10 px-2 leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300 px-4 sm:px-0">
            <Button 
              size="lg" 
              className="group w-full sm:w-auto px-6 sm:px-8 h-11 sm:h-12 md:h-14 text-sm sm:text-base md:text-lg font-semibold bg-gradient-to-r from-primary to-accent hover:opacity-90 shadow-xl shadow-primary/25 transition-all duration-300 hover:-translate-y-0.5"
              asChild
            >
              <a href="#content">
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="w-full sm:w-auto px-6 sm:px-8 h-11 sm:h-12 md:h-14 text-sm sm:text-base md:text-lg font-semibold border-border/50 hover:border-primary/50 hover:bg-primary/5"
              asChild
            >
              <a 
              ...
              >
                <svg className="h-4 w-4 sm:h-5 sm:w-5 mr-2 text-[#25D366]" fill="currentColor" viewBox="0 0 24 24">
